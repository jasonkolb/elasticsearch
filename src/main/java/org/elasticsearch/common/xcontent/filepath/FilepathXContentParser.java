package org.elasticsearch.common.xcontent.filepath;
 ...
 */
public class FilepathXContentParser extends AbstractXContentParser {

    public final static String TYPENAME = "filepath";

    final JsonParser parser;

    public FilepathXContentParser(JsonParser parser) {
        this.parser = parser;
    }

    @Override
    public XContentType contentType() {
        return XContentType.FILEPATH;
    }
